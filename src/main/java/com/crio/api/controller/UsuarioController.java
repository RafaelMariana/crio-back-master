...
public class UsuarioController {
    ...
    @GetMapping("/{tipo}")
    public ResponseEntity<Optional<Usuario>> findByTipo(@PathVariable("Tipo") int tipo) {
        Optional<Usuario> usuario = usuarioService.findByTipo(tipo);
        return ResponseEntity.ok(usuario);

    }
    @PostMapping("/created", consumes = "multipart/form-data")
   public Optional<Usuario> findByCreatedAtBetween (
